...
const Footer = () => {
  return <footer className="bg-alphadarkblue border-t border-white/5 pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            <img alt="Alpha Tech BR Logo" className="h-12" src="/lovable-uploads/7d74611e-ab3a-4880-afbd-bf84a549e6a5.png" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">loja.alphatechbr@gmail.com</span>
              </li>
              <li className="mt-4">
                <a href="https://wa.me/5511xxxxxxxxx" target="_blank" rel="noreferrer" className="bg-gradient-tech py-2 px-4 rounded-full text-white inline-flex items-center space-x-1 hover:opacity-90 transition-opacity">
