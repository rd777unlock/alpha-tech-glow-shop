            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-gray-300 mb-6">
                  A Alpha Tech BR nasceu da paixão por tecnologia e da vontade
                  de oferecer produtos premium com um atendimento diferenciado
                  no mercado brasileiro. Fundada em 2018, nossa empresa se
                  consolidou como referência em produtos Apple e acessórios de
                  alta qualidade.
                </p>
                ...
                <p className="text-gray-300 mb-6">
                  Proporcionar a melhor experiência em produtos tecnológicos,
                  com foco em qualidade, atendimento personalizado e suporte
                  contínuo aos nossos clientes. Queremos que cada cliente tenha
                  acesso ao que há de melhor em tecnologia, com a segurança e
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-12">
                  <div className="bg-alphadarkblue/70 rounded-xl p-6">
                    ...
                    <p className="text-gray-400">
                      ...
                      lançamentos do mundo da tecnologia.
                    </p>
                  </div>
                  ...
                  <div className="bg-alphadarkblue/70 rounded-xl p-6">
                    ...
                    <p className="text-gray-400">
                      Construímos relacionamentos duradouros baseados em
                      transparência e produtos de qualidade.
                    </p>
                  </div>
                  ...
                  <div className="bg-alphadarkblue/70 rounded-xl p-6">
                    ...
                    <p className="text-gray-400">
                      Oferecemos suporte personalizado antes, durante e após a
                      compra para total satisfação.
                    </p>
                  </div>
                </div>

                <h2 className="text-gradient text-3xl font-bold mt-10">
                  Por que escolher a Alpha Tech BR?
                </h2>
                ...
                <div className="mt-10 bg-gradient-to-br from-alphadarkblue to-alphadark p-8 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-300 mb-6">
                    Estamos à disposição para tirar suas dúvidas e ajudar com
                    qualquer questão relacionada aos nossos produtos e serviços.
                  </p>
                  <a
