...
const ProductPage = () => {
  ...
  const handleWhatsAppBuy = () => {
    if (product) {
      ...
      // Abrir WhatsApp (número fictício)
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
                ...
                <div className="bg-alphadarkblue/40 rounded-2xl overflow-hidden mb-4">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      target.src = "https://placehold.co/800x800/alphadark/gray?text=Imagem+Indisponível";
                    }}
                  />
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <img 
                      ...
                      onError={(e) => {
                        const target = e.target as HTMLImageElement;
                        target.src = "https://placehold.co/80x80/alphadark/gray?text=Imagem+Indisponível";
                      }}
                    />
                  </button>
                </div>
              ...
              <div className="md:w-1/2">
                      ...
                      <div>
                        ...
                        <div className="flex items-center text-alphagreen text-sm">
                          <img 
                            ...
                            onError={(e) => {
                              const target = e.target as HTMLImageElement;
                              target.src = "https://placehold.co/16x16/alphadark/gray?text=L";
                            }}
                          />
                          Entrega rápida
                        </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  <Button
                    className="bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg h-auto transition-colors"
