...
const CheckoutSuccess = () => {
  ...
  const orderNumber = `ALF${Math.floor(Math.random() * 1000000).toString().padStart(6, '0')}`;
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-alphadarkblue rounded-2xl p-6 md:p-10 text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Pedido Confirmado!</h1>
            <p className="text-gray-300 mb-8 max-w-xl mx-auto">
              Obrigado pela sua compra. Seu pedido foi processado com sucesso e em breve enviaremos um email com os detalhes.
            </p>
            ...
            <div className="bg-alphadark/40 rounded-xl p-6 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <h3 className="text-gray-400 text-sm mb-1">Entrega Estimada</h3>
                  <p className="text-white font-medium">{formattedDeliveryDate}</p>
                </div>
              </div>
            </div>
            
            <div className="mb-10">
              <h2 className="text-xl text-white font-medium mb-6">Próximos Passos</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-alphadark/40 rounded-xl p-5">
                  ...
                  <p className="text-gray-400 text-sm">Seu pedido está sendo processado e será preparado para envio.</p>
                </div>
                ...
                <div className="bg-alphadark/40 rounded-xl p-5">
                  ...
                  <p className="text-gray-400 text-sm">Você receberá um email com o código de rastreamento quando seu pedido for despachado.</p>
                </div>
                ...
                <div className="bg-alphadark/40 rounded-xl p-5">
                  ...
                  <p className="text-gray-400 text-sm">Seu pedido será entregue no endereço informado no prazo estimado.</p>
                </div>
              </div>
            </div>
